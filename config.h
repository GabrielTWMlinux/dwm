...
static const char *fonts[]          = { "SymbolaRegular:size=11:autohint=true:antialias=true" , "NotoColorEmoji:pixelsize=11:antialias=true:autohint=true" , "fontawesome:size=11:autohint=true:antialias=true" };
