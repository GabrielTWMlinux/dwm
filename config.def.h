...
static Key keys[] = {
	...
	{ ShiftMask,                    XK_p,      spawn,          SHCMD("~/.config/Scripts/dmenu/src-script") },
	{ ShiftMask,                    XK_w,      spawn,          SHCMD("~/.config/Scripts/wallpaper") },
	{ MODKEY,                       XK_x,      spawn,          SHCMD("~/.config/Scripts/dmenu/dmenu_power") },
	{ MODKEY,                       XK_r,      spawn,          SHCMD("~/.config/Scripts/dmenu/dmenu-files") },
	...
	{ ControlMask, 	                XK_o,      togglefloating, {0} },
